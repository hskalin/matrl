...
def modify_cfg(cfg_dict):
    ...
    cfg_dict["env"]["num_envs"] = 5
    cfg_dict["env"]["goal"]["type"] = "fix"
    cfg_dict["env"]["goal"]["style"] = "circle" # square, hourglass, circle
    cfg_dict["env"]["goal"]["trigger_dist"] = 5.5
    if "aero" in cfg_dict["env"]:
        cfg_dict["env"]["aero"]["wind_mag"] = 1.5
...
def launch_rlg_hydra(cfg: DictConfig):
    ...
    model_folder = (
        "/home/yutang/rl/sf_mutitask_rl/logs/rmacompblimp/BlimpRand/2024-01-11-21-36-57"
    )
    model_checkpoint = "model165" 
